...
class VersionRepositoryTest extends AbstractRepositoryTestCase
{
    ...
    public function testAdd(): void
    {
        ...
        $payload = ['name' => '2.1.0', 'description' => 'Release 2.1.0', 'archived' => false, 'releaseDate' => '2025-08-18T00:00:00+00:00'];
    ...
    public function testUpdate(): void
    {
        $version = (new Version())
            ...
            ->setDescription('Release 2.1.0')
            ->setReleaseDate(new \DateTimeImmutable('2025-08-18'));
        $payload = ['id' => '2000', 'name' => '2.1.0', 'description' => 'Release 2.1.0', 'archived' => false, 'releaseDate' => '2025-08-18T00:00:00+00:00'];
        $result = [...$payload];
